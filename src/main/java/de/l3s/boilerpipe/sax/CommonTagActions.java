...
public abstract class CommonTagActions {
	 ...
	 * skipped.
	 */
	public static final TagAction TA_META_ELEMENT = new TagAction() {
		...
		public boolean start(final BoilerpipeHTMLContentHandler instance,
			...
			String property = atts.getValue("name") != null ? atts
					.getValue("name") : atts.getValue("NAME");
			if (property == null) {
				property = atts.getValue("property") != null ? atts
						.getValue("property") : atts.getValue("PROPERTY");
			}
			if (property == null)
				return true;
			property = property.toUpperCase();
			
			String value = atts.getValue("content") != null ? atts
					.getValue("content") : atts.getValue("CONTENT");
			
			if (property.equalsIgnoreCase(DESCRIPTION) || property.equalsIgnoreCase(OG_DESCRIPTION)) {
				instance.setDescription(value);
			} else if (property.equalsIgnoreCase(AUTHORS)) {
				instance.setAuthors(value);
			} else if (property.equalsIgnoreCase(KEYWORDS)) {
				instance.setKeywords(value);
			} else if (property.equalsIgnoreCase(OG_IMAGE)) {
	...
	public static final TagAction TA_LINK_ELEMENT = new TagAction() {

		private final String IMAGE_SRC = "IMAGE_SRC";
		
		public boolean start(final BoilerpipeHTMLContentHandler instance,
				final String localName, final String qName,
				final Attributes atts) {
			String property = atts.getValue("rel") != null ? atts
					.getValue("rel") : atts.getValue("REL");
			if (property == null)
				return true;
			property = property.toUpperCase();
			String value = atts.getValue("href") != null ? atts
					.getValue("href") : atts.getValue("HREF");
			
			if (property == IMAGE_SRC) {
