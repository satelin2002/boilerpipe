...
public final class BlockProximityFusion implements BoilerpipeFilter {
	...
	public static final BlockProximityFusion MAX_DISTANCE_1 = new BlockProximityFusion(
			1, false, false);
	public static final BlockProximityFusion MAX_DISTANCE_2 = new BlockProximityFusion(
			2, false, false);
	public static final BlockProximityFusion MAX_DISTANCE_3 = new BlockProximityFusion(
			3, false, false);
	public static final BlockProximityFusion MAX_DISTANCE_4 = new BlockProximityFusion(
			4, false, false);
	public static final BlockProximityFusion MAX_DISTANCE_5 = new BlockProximityFusion(
			4, false, false);
	...
	public boolean process(TextDocument doc)
		...
		for (Iterator<TextBlock> it = textBlocks.listIterator(offset); it
			...
			if (diffBlocks <= maxBlocksDistance) {
				...
				if (ok && sameTagLevelOnly
						&& prevBlock.getTagLevel() != block.getTagLevel()) {
					ok = false;
				}
				if (ok) {
