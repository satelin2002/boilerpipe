...
import de.l3s.boilerpipe.filters.simple.TagNameBoilerplateFilter;
...
import de.l3s.boilerpipe.filters.simple.StopWordsBoilerplateFilter;
import de.l3s.boilerpipe.filters.simple.AuthorDateFilter;
...
public final class ArticleSentencesExtractor extends ExtractorBase {
    ...
    public boolean process(TextDocument doc)
        ...
        ArticleExtractor.INSTANCE.process(doc)
                ...
                | StopWordsBoilerplateFilter.INSTANCE.process(doc)
                | MinClauseWordsFilter.INSTANCE.process(doc)
        		    | TagNameBoilerplateFilter.INSTANCE.process(doc)
        		    | AuthorDateFilter.INSTANCE.process(doc);
    }
