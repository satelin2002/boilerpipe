...
public abstract class ExtractorBase implements BoilerpipeExtractor {
     ...
     */
    public TextDocument getText(final String html)
            throws BoilerpipeProcessingException {
        try {
     ...
     * @throws BoilerpipeProcessingException
     */
    public TextDocument getText(final InputSource is)
            throws BoilerpipeProcessingException {
        try {
     ...
     * @throws BoilerpipeProcessingException
     */
    public TextDocument getText(final URL url) throws BoilerpipeProcessingException {
        try {
     ...
     * @throws BoilerpipeProcessingException
     */
    public TextDocument getText(final Reader r) throws BoilerpipeProcessingException {
     ...
     * @throws BoilerpipeProcessingException
     */
    public TextDocument getText(TextDocument doc)
            throws BoilerpipeProcessingException {
        process(doc);
        return doc;
    }    
